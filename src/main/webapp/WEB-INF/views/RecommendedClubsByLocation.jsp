    ...
    <div class="container">
        <header>
            ...
            <p class="sub-description">
                회원님의 활동 지역 기반으로 추천된 모임 목록입니다.
            </p>
            <p class="sub-description">
                현재 활동 지역: 
                <span class="highlight-region">
                    <c:out value="${memberSido}" /> <c:out value="${memberGugun}" />
                </span>
            </p>
        </header>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="no-club-message">
                    <i class="fas fa-box-open fa-3x text-gray-400 mb-3" style="color: #ccc;"></i>
                    <h3>추천 모임 없음</h3>
                    <p class="mt-1 text-sm text-gray-500">
                        현재 활동 지역(<span style="font-weight: 600;"><c:out value="${memberSido}" /> <c:out value="${memberGugun}" /></span>) 내에서
                        회원님의 관심 카테고리와 일치하며 모집 중인 모임이 없습니다.
                    </p>
                    <div class="mt-4">
